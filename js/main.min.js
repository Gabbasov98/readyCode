...
const parallaxContainers=document.querySelectorAll(".parallax-container");parallaxContainers.forEach(t=>{t.querySelectorAll(".parallax-item").forEach(e=>{let a=0,n=0,o=0,s=0;!function t(){a+=.15*(o-a)*.125,n+=.15*(s-n)*.125,e.style.cssText=`transform: translate(${a/10}%,${n/30}%);`,requestAnimationFrame(t)}(),t.addEventListener("mousemove",(function(e){const a=t.offsetWidth,n=t.offsetHeight,i=e.pageX-a/2,r=e.pageY-n/2;o=i/a*100,s=r/n*100}))})}),butter.init({cancelOnTouch:!0}),$((function(){$(".m-btn").on("mouseenter",(function(t){var e=$(this).offset(),a=t.pageX-e.left,n=t.pageY-e.top;$(this).find("._animate-span").css({top:n,left:a})})).on("mouseout",(function(t){var e=$(this).offset(),a=t.pageX-e.left,n=t.pageY-e.top;$(this).find("._animate-span").css({top:n,left:a})}))}));
